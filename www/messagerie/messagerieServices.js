angular.module('ent.message_services', ['ent.request'])
  ...
  .service('MessagerieServices', function ($q, domainENT, RequestService, $http) {
    ...
    this.saveWithId = function (id, mailData) {
      return RequestService.put(domainENT + '/conversation/draft/' + id, mailData);
    }
    ...
    this.sendMail = function (mailData) {
      return RequestService.post(domainENT + '/conversation/send?id=' + mailData.id, mailData);
    }

    this.sendReplyOne = function (mailData) {
      return RequestService.post(domainENT + '/conversation/send?In-Reply-To=' + mailData.id, mailData);
