...
.controller('LoginCtrl', function($scope, $http, $cordovaInAppBrowser, $state, domainENT) {
  ...
  function login(){
    ...
    var ref = window.open(domainENT+'/auth/oauth2/auth?response_type=code&state=blip&scope=userinfo&client_id=mobile-ong&redirect_uri='+domainENT,'_self','location=no','toolbar=no', 'clearcache=yes', 'clearsessioncache=yes');
